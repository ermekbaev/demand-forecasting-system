...
const ForecastResultsTab: React.FC<ForecastResultsTabProps> = ({
  ...
  return (
    <div className="card">
      ...
      {currentForecast ? (
        <div className="mb-6">
          <h3 className="text-sm font-medium mb-2" style={{ color: themeColors.darkTeal }}>Текущий прогноз</h3>
